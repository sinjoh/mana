...
p4est_connectivity_t* create_connectivity(bool periodic) {
    if (periodic) {
...
int main(int argc, char* argv[]) {
    bool periodic = false;
    if (argc > 1 && std::string(argv[1]) == "--periodic") {
        periodic = true;
    }
    ...
    // Initialize p4est with or without periodic boundary conditions
    p4est_connectivity_t *conn = create_connectivity(periodic);
