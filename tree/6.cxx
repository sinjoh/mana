...
void BalanceGrid(vtkSmartPointer<vtkUniformHyperTreeGrid> hyperTreeGrid) {
    bool balanced = false;
    while (!balanced) {
        balanced = true;
...
void UpdateCellData(vtkSmartPointer<vtkUniformHyperTreeGrid> hyperTreeGrid) {
...
{
    // Create a uniform hyper tree grid source
    vtkSmartPointer<vtkUniformHyperTreeGridSource> hyperTreeGridSource = 
        vtkSmartPointer<vtkUniformHyperTreeGridSource>::New();
    ...
    vtkSmartPointer<vtkUniformHyperTreeGrid> hyperTreeGrid = hyperTreeGridSource->GetOutput();
